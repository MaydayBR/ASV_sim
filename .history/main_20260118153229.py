...
heading_len = 0.6
heading_line, = ax.plot([x, x + heading_len], [y, y], linewidth=2)
...
with open("run_log.csv", "w", newline="") as f:
    ...
    while i < len(waypoints):
        ...
        desired_heading = math.atlan2(dy,dx)                        #angle that points directly towards the target
        heading = update_heading(heading, desired_heading, max_turn_rate, dt)   #how much to turn 
